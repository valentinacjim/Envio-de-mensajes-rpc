...
int
_server_delete_key_1 (int  *argp, void *result, struct svc_req *rqstp)
{
	return (server_delete_key_1_svc(*argp, result, rqstp));
}
...
claves_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case server_delete_key:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (bool_t (*) (char *, void *,  struct svc_req *))_server_delete_key_1;
		break;
